...
namespace RPG
{
    public class GameState : State
    {
        ...
        public GameState(Game1 game, GraphicsDevice graphicsDevice, ContentManager content, SpriteBatch spriteBatch) : base(game, graphicsDevice, content)
        {
            ...
            Fight.texture = _content.Load<Texture2D>("battleroom");
            Fight.Animation = _content.Load<Texture2D>("Animation");
            Fight.HPBarMonstra = _content.Load<Texture2D>("hp-bar");
