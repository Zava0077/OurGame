...
namespace RPG
{
    class Slot : Inventory
    {
        ...
        public static Color colorPrikol = Color.Transparent;
        ...
        public void Draw()
        {
            ...
            Inventory.spriteBatch.Draw(texture, new Vector2(_currentMouse.X - 32, _currentMouse.Y - 32), SlotCheckerRectangleValue, colorPrikol); //прорисовка Невидимого слота
            spriteBatch.End();
        }
        ...
        {
            colorPrikol = Color.White;
            if (Slots[currentId].isEmpty == true)
            {
                colorPrikol = Color.Transparent;
            }
