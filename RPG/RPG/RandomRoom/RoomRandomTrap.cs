...
namespace RPG
{
    class RoomRandomTrap : Room
    {
        public static List<RoomRandomTrap> RoomRandomTraps = new List<RoomRandomTrap>();
        ...
        public RoomRandomTrap(Vector2 Pos, int idRoom, Texture2D texture)
        {
            this.idRoom = idRoom;
            this.Pos = Pos;
            ...
            if (mouseRectangle.Intersects(Rectangle))
            {
                ...
                if (_currentMouse.LeftButton == ButtonState.Released && _previousMouse.LeftButton == ButtonState.Pressed)
                {
                    if (Game1.self.isFirstsquare == true)
                    {
                        ...
                        Player.player.PlayerHP -= rnd.Next(0, 45);
                        Player.player.Exp += rnd.Next(0, 50);
